...
namespace SyntyTools
{
  public class SyntyStoreSearch : EditorWindow
  {
    ...
    {
      float size = GUILayout.HorizontalSlider(imageWidth, 40, 200, this.sliderStyle, GUI.skin.horizontalSliderThumb,
      GUILayout.Width(150));

      this.imageWidth = Mathf.RoundToInt(size);
      this.imageHeight = Mathf.RoundToInt(size);
    }
